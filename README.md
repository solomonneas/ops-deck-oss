...
- Express telemetry API serving JSON-backed cron jobs, architecture, security, backlog, and intel endpoints from [`api/data`](/home/user/repos/ops-deck-oss/api/data).
...
- PM2 deployment notes are available in [docs/pm2-setup.md](/home/user/repos/ops-deck-oss/docs/pm2-setup.md).
