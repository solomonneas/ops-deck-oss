...
MEMORY_DIR = Path(os.environ.get("MEMORY_DIR", "/home/user/.openclaw/workspace/memory"))
CARDS_DIR = Path(os.environ.get("CARDS_DIR", "/home/user/.openclaw/workspace/memory/cards"))
REPOS_OVERLAY = Path(os.environ.get("REPOS_OVERLAY", "/home/user/repos/ops-deck-oss/repos.json"))
REPO_DETAIL_OVERLAY = Path(os.environ.get(
    "REPO_DETAIL_OVERLAY",
    "/home/user/repos/ops-deck-oss/repos-detail.json",
))
CODEBASE_OVERLAY = Path(os.environ.get(
    "CODEBASE_OVERLAY",
    "/home/user/repos/ops-deck-oss/codebase.json",
))
